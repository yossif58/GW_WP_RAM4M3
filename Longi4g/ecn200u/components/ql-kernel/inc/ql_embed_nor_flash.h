...
typedef enum 
{
    QUEC_BOT_PARTITION_ID_KV, /* kv partition */
    QUEC_BOT_PARTITION_ID_MAX
}quec_bot_partition_id_e;
...
}quec_bot_hal_logic_partition_t;

extern quec_bot_hal_logic_partition_t * ql_bot_get_flash_partition(quec_bot_partition_id_e id);
#endif
