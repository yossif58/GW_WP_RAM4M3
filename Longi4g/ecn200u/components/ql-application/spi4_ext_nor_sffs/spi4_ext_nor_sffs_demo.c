...
static void ql_spi4_ext_nor_sffs_demo_task_pthread(void *ctx)
{
...
#if 0
    ql_errcode_spi_nor_e ret = ql_spi_nor_init(QL_SPI_PORT2, QL_SPI_CLK_26MHZ);
#else
    ...
    ql_errcode_spi_nor_e ret = ql_spi_nor_init_ext(nor_config);
#endif
    ...
    int64 free_size = ql_fs_free_size("EXNSFFS:");
