...
void test_tone_dtmf(void)
{
    ...
    ql_aud_dtmf_tone_init();

    ql_aud_dtmf_play(AUDIOHAL_DTMF_4,1000,1000);// dtmf "4", play 1s, mute 1s
    ql_rtos_task_sleep_ms(200);
    ql_aud_dtmf_play(AUDIOHAL_DTMF_5,500,500);// dtmf "5",play 0.5s, mute 0.5s
    ql_rtos_task_sleep_ms(200);
    ql_aud_tone_play(300,1000,300,300); //tone freq1:300Hz freq2:1000Hz,play 0.3s, mute 0.3s
